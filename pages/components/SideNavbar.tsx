...
const SideNavbar: React.FC<SideNavbarProps> = ({ className }) => {
    ...
    return (
        <nav className={`side-navbar bg-slate-700 flex flex-col h-full py-6 drop-shadow ${className}`}>
            <h1 className='text-xl mb-4 self-center'>NTS Noetics</h1>
            <ul className='flex gap-3 flex-col justify-start items-center flex-grow space-y-1'>
